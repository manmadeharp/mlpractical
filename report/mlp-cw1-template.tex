...
\usepackage{subcaption}    % for \begin{subfigure} ... \end{subfigure}
...
As with previous experiments, they are trained with the Adam optimizer with a learning rate of $10^{-3}$ and a batch size of 100. 
